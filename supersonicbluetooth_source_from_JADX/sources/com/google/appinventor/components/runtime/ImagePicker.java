...
public class ImagePicker extends Picker implements ActivityResultListener {
    ...
    class C02802 implements Comparator<File> {
        C02802() {
        }
    ...
    class C05071 implements PermissionResultHandler {
        C05071() {
        }
    ...
    public void click() {
        if (this.havePermission) {
            ...
            this.container.$form().askPermission("android.permission.WRITE_EXTERNAL_STORAGE", new C05071());
        }
    }
