...
public class ReplForm extends Form {
    ...
    class C03202 implements OnMenuItemClickListener {
        C03202() {
        }
    ...
    class C03213 implements OnMenuItemClickListener {
        C03213() {
        }
    ...
    public void addSettingsButton(Menu menu) {
        menu.add(0, 0, 3, "Settings").setOnMenuItemClickListener(new C03202()).setIcon(17301651);
    }

    public void addLogcatButton(Menu menu) {
        if (ReplApplication.isAcraActive()) {
            menu.add(0, 0, 4, "Send Error Report").setOnMenuItemClickListener(new C03213()).setIcon(17301642);
        }
    }
