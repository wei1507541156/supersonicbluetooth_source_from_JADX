    ...
    public void Start() {
        if (!this.havePermission) {
            ...
            this.form.runOnUiThread(new Runnable() {
                ...
                /* renamed from: com.google.appinventor.components.runtime.SoundRecorder$1$1 */
                class C05191 implements PermissionResultHandler {
                    C05191() {
                    }
                    ...
                    public void HandlePermissionResponse(String permission, boolean granted) {
                        ...
                        SoundRecorder.this.form.dispatchPermissionDeniedEvent(me, "Start", "android.permission.RECORD_AUDIO");
                    }
                }

                public void run() {
                    SoundRecorder.this.form.askPermission("android.permission.RECORD_AUDIO", new C05191());
                }
            });
