...
public class TextToSpeech extends AndroidNonvisibleComponent implements Component, OnStopListener, OnResumeListener, OnDestroyListener {
    ...
    class C05201 implements TextToSpeechCallback {
        C05201() {
        }
    ...
    public TextToSpeech(ComponentContainer container) {
        ...
        ITextToSpeech externalTextToSpeech;
        ...
        TextToSpeechCallback callback = new C05201();
        if (useExternalLibrary) {
            externalTextToSpeech = new ExternalTextToSpeech(container, callback);
        } else {
            externalTextToSpeech = new InternalTextToSpeech(container.$context(), callback);
        }
        this.tts = externalTextToSpeech;
