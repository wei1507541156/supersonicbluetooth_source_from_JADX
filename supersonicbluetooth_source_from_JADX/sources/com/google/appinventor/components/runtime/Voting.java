...
public class Voting extends AndroidNonvisibleComponent implements Component {
    ...
    class C05252 implements AsyncCallbackPair<JSONObject> {
        ...
        class C03684 implements Runnable {
            C03684() {
            }
        ...
        public void onSuccess(JSONObject result) {
            if (result == null) {
                Voting.this.androidUIHandler.post(new C03651());
                return;
            }
            try {
                ...
                if (Voting.this.isPolling.booleanValue()) {
                    ...
                    Voting.this.androidUIHandler.post(new C03662());
                    return;
                }
                Voting.this.androidUIHandler.post(new C03673());
            } catch (JSONException e) {
                Voting.this.androidUIHandler.post(new C03684());
            }
        }
    ...
    class C05264 implements AsyncCallbackPair<String> {
        ...
        public void onSuccess(String response) {
            Voting.this.androidUIHandler.post(new C03711());
        }
    ...
    public void RequestBallot() {
        AsynchUtil.runAsynchronously(new C03641());
    }
    ...
    public void SendBallot() {
        AsynchUtil.runAsynchronously(new C03703());
    }
