...
public class PhoneStatus extends AndroidNonvisibleComponent implements Component {
    ...
    /* renamed from: com.google.appinventor.components.runtime.PhoneStatus$1 */
    ...
    public String setHmacSeedReturnCode(String seed, String rendezvousServer) {
        ...
        if (this.firstSeed != null) {
            if (!this.firstSeed.equals(seed)) {
                Notifier.oneButtonAlert(Form.getActiveForm(), "You cannot use two codes with one start up of the Companion. You should restart the Companion and try again.", "Warning", "OK", new C03181());
            }
