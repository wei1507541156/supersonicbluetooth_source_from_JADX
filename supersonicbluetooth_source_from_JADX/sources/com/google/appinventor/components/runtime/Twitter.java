...
public final class Twitter extends AndroidNonvisibleComponent implements ActivityResultListener, Component {
    ...
    class C03566 implements Runnable {
        ...
        class C03551 implements Runnable {
            ...
            public void run() {
                ...
                for (Status status : C03566.this.replies) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.handler.post(new C03551());
            }
        }
    }
    ...
    class C03587 implements Runnable {
        ...
        class C03571 implements Runnable {
            ...
            public void run() {
                ...
                for (User user : C03587.this.friends) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.handler.post(new C03571());
            }
        }
    }

    /* renamed from: com.google.appinventor.components.runtime.Twitter$8 */
    class C03608 implements Runnable {
        ...
        class C03591 implements Runnable {
            ...
            public void run() {
                ...
                for (DirectMessage message : C03608.this.messages) {
        ...
        public void run() {
            try {
                ...
                Twitter.this.handler.post(new C03591());
            }
        }
    }
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                if (Twitter.this.checkAccessToken(myConsumerKey, myConsumerSecret)) {
                    Twitter.this.handler.post(new C03441());
                    return;
                }
                try {
                    ...
                    Twitter.this.handler.post(new C03452());
                }
            }
        });
    }
    ...
    public void CheckAuthorized() {
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                if (Twitter.this.checkAccessToken(myConsumerKey, myConsumerSecret)) {
                    Twitter.this.handler.post(new C03491());
                }
            }
        });
    }
                ...
                AsynchUtil.runAsynchronously(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            Twitter.this.handler.post(new C03511());
                        } catch (TwitterException e) {
    ...
    public void RequestMentions() {
        ...
        AsynchUtil.runAsynchronously(new C03566());
    }
    ...
    public void RequestFollowers() {
        ...
        AsynchUtil.runAsynchronously(new C03587());
    }
    ...
    public void RequestDirectMessages() {
        ...
        AsynchUtil.runAsynchronously(new C03608());
    }
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Twitter.this.handler.post(new C03471());
                }
            }
        });
    }
