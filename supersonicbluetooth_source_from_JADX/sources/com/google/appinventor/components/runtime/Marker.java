...
public class Marker extends MapFeatureBaseWithFill implements MapMarker {
    ...
    private static final MapFeatureVisitor<Double> bearingComputation = new C05132();
    private static final MapFeatureVisitor<Double> distanceComputation = new C05121();
    ...
    static class C05121 implements MapFeatureVisitor<Double> {
        C05121() {
        }
    ...
    static class C05132 implements MapFeatureVisitor<Double> {
        C05132() {
        }
