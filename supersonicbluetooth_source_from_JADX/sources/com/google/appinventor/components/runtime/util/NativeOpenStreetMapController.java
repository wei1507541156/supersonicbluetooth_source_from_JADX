...
class NativeOpenStreetMapController implements MapController, MapListener {
    private static final float[] ANCHOR_HORIZONTAL = new float[]{Float.NaN, 0.0f, 1.0f, 0.5f};
    private static final float[] ANCHOR_VERTICAL = new float[]{Float.NaN, 0.0f, 0.5f, 1.0f};
