...
public class InternalTextToSpeech implements ITextToSpeech {
    ...
    class C04001 implements OnInitListener {
        C04001() {
        }
    ...
    class C04022 implements OnUtteranceCompletedListener {
        ...
        public void onUtteranceCompleted(String utteranceId) {
            InternalTextToSpeech.this.activity.runOnUiThread(new C04011());
        }
    }
    ...
    private void initializeTts() {
        if (this.tts == null) {
            ...
            this.tts = new TextToSpeech(this.activity, new C04001());
        }
    }
    ...
    private void speak(final String message, final Locale loc, final int retries) {
        ...
        if (this.isTtsInitialized) {
            ...
            this.tts.setOnUtteranceCompletedListener(new C04022());
