...
public class FullScreenVideoUtil implements OnCompletionListener, OnPreparedListener {
    ...
    /* renamed from: com.google.appinventor.components.runtime.util.FullScreenVideoUtil$2 */
    class C03982 implements OnTouchListener {
        C03982() {
        }
    ...
    public Dialog createFullScreenVideoDialog() {
        ...
        this.mFullScreenVideoView.setOnTouchListener(new C03982());
    ...
    public void onPrepared(MediaPlayer arg0) {
        ...
        this.mFullScreenVideoView.start();
        this.mHandler.postDelayed(new C03993(), 100);
    }
