...
public class FirebaseDB extends AndroidNonvisibleComponent implements Component {
    ...
    class C02461 implements ChildEventListener {
        C02461() {
        }
    ...
    class C02482 implements AuthStateListener {

        /* renamed from: com.google.appinventor.components.runtime.FirebaseDB$2$1 */
        class C02471 implements AuthResultHandler {
            C02471() {
            }
        ...
        public void onAuthStateChanged(AuthData data) {
            ...
            if (data == null) {
                FirebaseDB.this.myFirebase.authWithCustomToken(FirebaseDB.this.firebaseToken, new C02471());
            }
        }
    }

    /* renamed from: com.google.appinventor.components.runtime.FirebaseDB$6 */
    class C02546 implements ValueEventListener {
        C02546() {
        }
    ...
    public FirebaseDB(ComponentContainer container) {
        ...
        this.projectBucket = "";
        this.firebaseToken = "";
        this.childListener = new C02461();
        this.authListener = new C02482();
    }
    ...
    public void GetTagList() {
        this.myFirebase.child("").addListenerForSingleValueEvent(new C02546());
    }
        ...
        firebase.runTransaction(new Transaction.Handler() {
            ...
            public void onComplete(final FirebaseError firebaseError, boolean committed, DataSnapshot currentData) {
                if (firebaseError != null) {
                    ...
                    FirebaseDB.this.androidUIHandler.post(new C02562());
