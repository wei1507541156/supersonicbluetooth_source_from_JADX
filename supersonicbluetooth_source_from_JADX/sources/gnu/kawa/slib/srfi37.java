...
public class srfi37 extends ModuleBody {
    ...
    public class frame5 extends ModuleBody {
        ...
        Object lambda20() {
            Boolean x = this.staticLink.staticLink.staticLink.lambda2findOption(this.staticLink.f99x);
            return x != Boolean.FALSE ? x : srfi37.option(LList.list1(this.staticLink.f99x), Boolean.TRUE, Boolean.FALSE, this.staticLink.staticLink.staticLink.unrecognized$Mnoption$Mnproc);
        }
    }
    ...
    public class frame6 extends ModuleBody {
        ...
        Object lambda22() {
            Procedure procedure = Scheme.apply;
            Object[] objArr = new Object[5];
            Object obj = this.f101x;
            try {
                objArr[0] = srfi37.optionProcessor((option$Mntype) obj);
                objArr[1] = this.f101x;
                objArr[2] = this.staticLink.staticLink.f99x;
                objArr[3] = this.staticLink.f100x;
