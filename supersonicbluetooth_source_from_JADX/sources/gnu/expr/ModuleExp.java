    ...
    void allocFields(Compilation comp) {
        ...
        while (decl != null) {
            if (decl.field == null) {
                ...
                if ((!decl.isSimple() || decl.isPublic() || decl.isNamespaceDecl() || (decl.getFlag(PlaybackStateCompat.ACTION_PREPARE) && decl.getFlag(6))) && !decl.getFlag(PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH)) {
