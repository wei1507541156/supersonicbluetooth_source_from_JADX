...
public class misc_syntax extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda4f() {
            Object x = ports.read(this.f107p);
            if (!ports.isEofObject(x)) {
                return new Pair(std_syntax.datum$To$SyntaxObject(this.f106k, x), lambda4f());
            }
            ports.closeInputPort(this.f107p);
            return LList.Empty;
        }
    }
    ...
    static Object lambda3(Object x) {
        ...
        frame.f106k = execute;
        try {
            frame.f107p = ports.openInputFile(Path.valueOf(fn));
